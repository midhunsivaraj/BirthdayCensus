 ...
 */
public class FragmentUserProfile extends BaseFragment implements TabLayout.OnTabSelectedListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                int top = mImageTabSelectedBackground.getTop();
                int left = mImageTabSelectedBackground.getLeft();
                int height = mImageTabSelectedBackground.getMeasuredHeight();
                int width = mImageTabSelectedBackground.getMeasuredWidth();


                RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams) mImageTabSelectedBackground.getLayoutParams();
                ...
                //int calculatedLeft = left - (width / 2) + marginLeft + requiredHeight+width/2;
                ...
                lpp.setMargins(0,calculatedTop,0,calculatedTop);

                mImageTabSelectedBackground.setLayoutParams(lpp);
        ...
        /*this.getView().getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        FragmentUserProfile.this.getView().getViewTreeObserver().removeOnGlobalLayoutListener(this);
                    }
                });
*/
        //endregion
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentUserAbout(), "ABOUT");
        //adapter.addFragment(new FragmentUserWishList(), "WISHLIST");
        adapter.addFragment(new FragmentUserFriends(), "FRIENDS");
